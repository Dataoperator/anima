...
export const canisterId = process.env.CANISTER_ID_ANIMA;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./anima.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the anima canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./anima.did.js")._SERVICE>}
 */
export const anima = createActor(canisterId);
